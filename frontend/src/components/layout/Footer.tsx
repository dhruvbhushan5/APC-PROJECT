      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold">LuxStay</h2>
                <p className="text-sm text-amber-400">Premium Hotels</p>
              </div>
            </div>
            <p className="text-gray-400 mb-4">
              Experience luxury and comfort at the finest hotels worldwide. 
              Your perfect stay awaits with our curated selection of premium accommodations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/hotels" className="text-gray-400 hover:text-amber-400 transition-colors">Browse Hotels</a></li>
              <li><a href="/reservations" className="text-gray-400 hover:text-amber-400 transition-colors">My Reservations</a></li>
              <li><a href="/profile" className="text-gray-400 hover:text-amber-400 transition-colors">My Profile</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {currentYear} LuxStay. All rights reserved. | Privacy Policy | Terms of Service
          </p>
        </div>
      </div>
    </footer>
